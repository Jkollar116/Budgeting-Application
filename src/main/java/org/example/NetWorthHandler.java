...
//
//        String assetsLiabilities = getJsonValue(body, "assetsLiabilities");
//        String crypto = getJsonValue(body, "crypto");
//        String stocks = getJsonValue(body, "stocks");
//        String netWorth = getJsonValue(body, "netWorth");
//
//        if (assetsLiabilities.isEmpty() || crypto.isEmpty() || stocks.isEmpty() || netWorth.isEmpty()) {
//            exchange.sendResponseHeaders(400, -1);
//            return;
//        }
//
//        String json = "{ \"fields\": {"
//                + "\"assetsLiabilities\": {\"stringValue\": \"" + escapeJson(assetsLiabilities) + "\"},"
//                + "\"crypto\": {\"stringValue\": \"" + escapeJson(crypto) + "\"},"
//                + "\"stocks\": {\"stringValue\": \"" + escapeJson(stocks) + "\"},"
//                + "\"netWorth\": {\"stringValue\": \"" + escapeJson(netWorth) + "\"}"
//                + "} }";
//
...
//            byte[] msg = "Net Worth saved.".getBytes(StandardCharsets.UTF_8);
